...
@section('content')
            ...
            <div class="single-slider slider-height slider-padding sky-blue d-flex align-items-center">
                <div class="container">
                    <div class="row d-flex align-items-center">
                        <div class="col-lg-6 col-md-9 ">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInUp" data-delay=".6s">Sarana Interaktif Masyarakat dan
                                    Pemerintah
    ...
    @auth
        ...
        <section class="best-pricing pricing-padding"
                 data-background="{{ asset('front') }}/img/gallery/best_pricingbg.jpg"
                 id="pengaduan">
            <div class="container">
                <!-- Section Tittle -->
                            ...
                            <div class="card-bottom">
                                <form action="{{ route('masyarakat.pengaduan.submit') }}" method="POST"
                                    ...
                                    <div class="mt-10 mb-5 text-left">
                                        ...
                                        <textarea class="single-textarea form-control w-100" name="isi_laporan"
                                                  id="message"
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="services-caption text-center mb-30">
                        ...
                        <div class="service-cap">
                            ...
                            <p>Pastikan anda login dan jika melum memiliki akun dapat mendaftar <a class="text-primary"
                                                                                                   href="{{ route('masyarakat.register') }}">disini.</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="services-caption text-center mb-30">
                        ...
                        <div class="service-cap">
                            ...
                            <p>Dalam 3 hari, laporan Anda akan diverifikasi dan diteruskan kepada instansi
                                berwenang.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="services-caption text-center mb-30">
                        <div class="service-icon">
                            <span class=""><img src="{{ asset('front') }}/img/freepik/speech-bubble.png"
                                                width="45%"></span>
                        </div>
                        <div class="service-cap">
                            <h4><a href="#">Beri Tanggapan</a></h4>
                            <p>Anda dapat menanggapi kembali balasan yang diberikan oleh instansi dalam waktu 10
                                hari.</p>
                        </div>
                    </div>
                </div>
    ...
    <!-- Customer Start -->
    <div class="our-customer section-padd-top30 mt-5" id="testimoni">
