...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Hi, {{ $user->nama_petugas }}</h2>
                    ...
                    <div class="card profile-widget">
                        ...
                        <div class="profile-widget-description">
                            ...
                            <form method="POST" class="needs-validation" novalidate=""
                                action="{{ route('petugas.update', $user->id_petugas ) }}">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input type="text" class="form-control" name="nama_petugas"
                                                value="{{ $user->nama_petugas }}" required="" id="form" disabled />
                            ...
                            <form method="POST" class="needs-validation" novalidate=""
                                action="{{ route('petugas.update2', $user->id_petugas ) }}">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-6 col-6">
                                            ...
                                            <input type="text" class="form-control" name="username"
                                                value="{{ $user->username }}" id="form5" disabled />
                                            <div class="invalid-feedback">
                        ...
                        <div class="card-footer text-center">
                            <div class="font-weight-bold mb-2">Follow {{ $user->nama_petugas }} On</div>
